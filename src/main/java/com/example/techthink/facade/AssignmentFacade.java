...
public class AssignmentFacade {
    ...
    public AssignmentResponse create(AssignmentRequest request){
        AssignmentDTO assignmentDTO = convertToDTO(request);
    ...
    public List<AssignmentResponse> readAll(){
        ...
        List<AssignmentResponse> assignmentResponses = assignments.stream().map(each -> readById(each.getId())).collect(Collectors.toList());
    ...
    private AssignmentDTO convertToDTO(AssignmentRequest request){
        ...
        assignmentDTO.setAssignmentFileURL(request.getAssignmentFileURL());
